 ...
 */
void Arbol::setLevel_arbol(int level)
{
  this->level = level;
}
 ...
 */
void Arbol::draw_arbol(int next)
{
  this->level = next;
  draw_arbol(next,this->p1,this->p2,false);
 ...
 */
void Arbol::quita_ultimo_nivel_arbol(int next)
{
  this->level = next;
  draw_arbol(next,this->p1,this->p2,true);
