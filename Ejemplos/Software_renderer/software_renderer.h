...
class SoftwareRendererImp : public SoftwareRenderer {
 ...
 private:
  ...
  void rasterize_line( float x0, float y0,
                       float x1, float y1,
                       Color color);
  bool checa_frontera( float x0, float y0,float x1, float y1,float x2, float y2,float x, float y);

  float maximo(float x0, float x1, float x2);
  
  float minimo(float x0, float x1, float x2);
  ...
  size_t sample_width;
  void muestra(float x, float y, float ix, float iy, Color c );
  void clear_target();
