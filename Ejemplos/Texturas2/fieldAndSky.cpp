...
void drawScene(void)
{
	...
	glBindTexture(GL_TEXTURE_2D, texture[0]);
	glBegin(GL_POLYGON);
	glTexCoord2f(0.0, 0.0); glVertex3f(-100.0, -4.0, 5.0);
	glTexCoord2f(8.0, 0.0); glVertex3f(100.0, -4.0, 5.0);
	glTexCoord2f(8.0, 8.0); glVertex3f(100.0, -4.0, -5.0);
	glTexCoord2f(0.0, 8.0); glVertex3f(-100.0, -4.0, -5.0);
	glEnd();

	// Map the sky texture onto a rectangle parallel to the xy-plane.
	glBindTexture(GL_TEXTURE_2D, texture[1]);
	glBegin(GL_POLYGON);
	glTexCoord2f(0.0, 0.0); glVertex3f(-100.0, -50.0, -70.0);
	glTexCoord2f(1.0, 0.0); glVertex3f(100.0, -50.0, -70.0);
